package com.rufus.weatherapp.view
...
import com.rufus.weatherapp.constant.Const.Companion.NA
import com.rufus.weatherapp.constant.Const.Companion.cardColor
import com.rufus.weatherapp.model.forecast.ForecastResult
import com.rufus.weatherapp.utils.Utils.Companion.buildIcon
import com.rufus.weatherapp.utils.Utils.Companion.timestampToHumanDate
...
fun ForecastTile(temp: String, image: String, time: String) {
    Card(
        ...
        colors = CardDefaults.cardColors(
            //code below is original color of the card
